...
import com.example.android.donationapp.View.Adapters.ActivityAdapter2;
...
public class DeleteActivityPage  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ActivityAdapter2.ActivityAdapter2OnClickHandler {
    ...
    private ActivityAdapter2 mAdapter;
        ...
        databaseCharityActivity.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snap : dataSnapshot.getChildren()) {
                    ...
                    Log.d("UpdateActivityPage",mCharityActivity.getCharityID()+"hello2");
                ...
                if(enter){
                    ...
                    enter=false;
                    Intent intent = new Intent(DeleteActivityPage.this, DeleteActivityValidation.class);
    ...
    protected void onResume() {
        navigationView.setCheckedItem(R.id.delete_activity);
        super.onResume();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseCharityActivity.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mCharityActivity_list = new CharityActivity[(int) dataSnapshot.getChildrenCount()];
                for (DataSnapshot snap : dataSnapshot.getChildren()) {
                    mCharityActivity = new CharityActivity();
                ...
                mView = (RecyclerView) findViewById(R.id.activity_recycle2);
                mView.setLayoutManager(new GridLayoutManager(DeleteActivityPage.this, 1));
                mAdapter = new ActivityAdapter2(DeleteActivityPage.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.update_activity:
                Intent intent3 = new Intent(this, UpdateActivityPage.class);
