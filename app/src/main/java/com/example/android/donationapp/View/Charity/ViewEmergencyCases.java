...
import com.example.android.donationapp.View.Adapters.EmergencyAdapter2;
...
public class ViewEmergencyCases  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, EmergencyAdapter2.EmergencyAdapter2OnClickHandler{
    ...
    private EmergencyAdapter2 mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = findViewById(R.id.drawer_layout78);
        ...
        toggle.syncState();
        navigationView.setCheckedItem(R.id.view_emergency);



        mView = (RecyclerView) findViewById(R.id.emergency_recycle2);
        mView.setLayoutManager(new GridLayoutManager(ViewEmergencyCases.this, 1));
        ...
        databaseEmergencyCase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(enter2){
                    mAdapter = new EmergencyAdapter2(ViewEmergencyCases.this);
